    ...
    : DbContext(options), IApplicationDbContext, IUnitOfWork
{
    ...
    protected override void OnModelCreating(ModelBuilder mb)
    {
        ...
        mb.Entity<Reunion>()   .HasQueryFilter(r => _alcanceGlobal || (r.InstitucionId != null && EF.Constant(_alcanceInst).Contains(r.InstitucionId.Value)));
...
public sealed class ReunionConfiguration : IEntityTypeConfiguration<Reunion>
{
    public void Configure(EntityTypeBuilder<Reunion> b)
    {
        ...
        b.Property(x => x.Desarrollo).HasMaxLength(4000);
