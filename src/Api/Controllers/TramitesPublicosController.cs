...
public sealed class TramitesPublicosController(ConsultaCatalogo catalogo, ConsultaFicha ficha) : ControllerBase
{
    ...
    {
        var resultado = await catalogo.EjecutarAsync(new CatalogoFiltros(
    ...
    {
        var dto = await ficha.EjecutarAsync(codigo, ct);
