...
/// <summary>Clave estática por cliente (decisión P-02, Fase 0). Adecuado para un solo
    ...
    : AuthenticationHandler<ApiKeyAuthenticationOptions>(options, logger, encoder)
{
    protected override Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        // P-03 (Fase 0, todavía abierta): en Development vive en appsettings/user-secrets;
        // dónde vive en producción está pendiente de decidir — ver M-07 del plan.
