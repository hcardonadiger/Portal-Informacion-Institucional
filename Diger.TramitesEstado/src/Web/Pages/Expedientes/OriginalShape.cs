...
public sealed class OriginalExpedienteDto
{
    ...
    public sealed class ReqOrig    { [JsonPropertyName("requisito")] public string? Requisito { get; set; } [JsonPropertyName("obs")] public string? Obs { get; set; } }
    ...
    public sealed class LegalOrig  { [JsonPropertyName("instrumento")] public string? Instrumento { get; set; } [JsonPropertyName("articulos")] public string? Articulos { get; set; } [JsonPropertyName("obs")] public string? Obs { get; set; } }
