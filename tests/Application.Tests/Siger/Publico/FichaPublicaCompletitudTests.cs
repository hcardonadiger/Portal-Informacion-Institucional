...
public sealed class FichaPublicaCompletitudTests
{
    ...
    public void Ficha_con_todo_capturado_no_tiene_faltantes()
    {
        var faltantes = FichaPublicaCompletitud.CamposFaltantes(
            Categoria, Modalidad, Tiempo, costoEsGratuito: true, estaEnSol: false, solUrl: null);

        faltantes.Should().BeEmpty();
        FichaPublicaCompletitud.Evaluar(
            Categoria, Modalidad, Tiempo, true, false, null).Should().BeTrue();
    }

    [Fact]
    public void Sin_categoria_la_reporta_como_faltante()
    {
        FichaPublicaCompletitud.CamposFaltantes(null, Modalidad, Tiempo, true, false, null)
    ...
    {
        FichaPublicaCompletitud.CamposFaltantes(Categoria, null, Tiempo, true, false, null)
    ...
    {
        FichaPublicaCompletitud.CamposFaltantes(Categoria, Modalidad, null, true, false, null)
            .Should().Equal("tiempo");
    }
    ...
    {
        FichaPublicaCompletitud.CamposFaltantes(Categoria, Modalidad, Tiempo, null, false, null)
            .Should().Equal("costo");
    }
    ...
    {
        FichaPublicaCompletitud.CamposFaltantes(Categoria, Modalidad, Tiempo, true, false, null)
    ...
    {
        FichaPublicaCompletitud.CamposFaltantes(Categoria, Modalidad, Tiempo, true, estaEnSol: true, solUrl: null)
            .Should().Equal("enlace a SOL");

        FichaPublicaCompletitud.CamposFaltantes(Categoria, Modalidad, Tiempo, true, estaEnSol: false, solUrl: null)
            .Should().BeEmpty();
    }
    ...
    {
        FichaPublicaCompletitud.CamposFaltantes(null, null, null, null, estaEnSol: true, solUrl: null)
    ...
    {
        var faltantes = FichaPublicaCompletitud.CamposFaltantes(
            categoriaId, modalidad, tiempo, gratuito, estaEnSol, solUrl: null);
