...
public class AccionProyectoTests : IDisposable
{
    ...
    // construir los handlers. Que se dispare tiene sus propias pruebas en ProyectoCommandsSyncTests.
    ...
    private Task<int> CrearAsync(string nombre, AccionProyecto? accion) =>
        new CrearProyectoCommandHandler(_ctx, _usuario, _sync).Handle(
